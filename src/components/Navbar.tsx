    ...
    return (
        <nav className="glass-panel" style={{
            ...
            <div style={{ marginTop: '1rem', padding: '0 1rem', fontSize: '0.7rem', color: 'var(--secondary)', opacity: 0.6 }}>
                version 1.1 by <a href="https://github.com/s-ruiter/proxmox-uploader" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecoration: 'underline' }}>sruiter</a>
            </div>
        </nav >
    );
}
